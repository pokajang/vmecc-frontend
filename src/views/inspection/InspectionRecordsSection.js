...
import InspectionMobileRecordsList from './records/InspectionMobileRecordsList'
import InspectionQueueBanner from './records/InspectionQueueBanner'
import InspectionQueueDetailsModal from './records/InspectionQueueDetailsModal'
import InspectionRecordsFilters from './records/InspectionRecordsFilters'
import InspectionRecordsTable from './records/InspectionRecordsTable'
...
const InspectionRecordsSection = ({
  ...
  return (
    <>
      ...
      <div className="inspection-mobile-section d-md-none" data-tour-id="inspection-records">
        {commonQueueBanner}
        <div className="d-flex justify-content-between align-items-center gap-2 mb-3">
          ...
          <div className="d-flex align-items-center gap-2">
            {showPrimaryAction ? (
              <CreateActionButton label="New" onClick={startNew} data-tour-id="inspection-new" />
            ) : null}
          </div>
        </div>
        {filters}
      ...
      <CCard className="d-none d-md-block" data-tour-id="inspection-records">
