...
const ClaimSubmitModal = ({
    ...
    <>
      <div className="d-grid gap-2">
        {summaryItems.map((item) => (
          <div key={item.label} className="d-flex justify-content-between align-items-start gap-3">
                        ...
                        {item.attachmentName && (
                          <div className="small text-body-secondary d-flex align-items-center justify-content-end gap-2">
                            ...
                            {typeof onPreviewAttachment === 'function' && (
                              <button
                                type="button"
                                className="btn btn-light btn-sm workflow-attachment-action"
  ...
  return (
    <ResponsiveWorkflowActionDialog
      ...
      className="payroll-claim-submit-modal"
    />
  )
}
