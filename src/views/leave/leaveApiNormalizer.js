...
export const normalizeApiLeaveRecord = (record) => {
  ...
  return {
    ...
    workflowTeamId: record.workflow_team_id ?? null,
    workflowTeamName: record.workflow_team_name ?? '',
    workflowApplicantRole: record.workflow_applicant_role ?? '',
    workflowRoutingSource: record.workflow_routing_source ?? '',
    dutyCoverageAssignmentId: record.duty_coverage_assignment_id ?? null,
