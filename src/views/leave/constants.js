...
export const IMAGE_CAMERA_COMPRESSION_TARGET_BYTES = 750 * 1024
export const MAX_ATTACHMENT_BYTES = 15 * 1024 * 1024
export const MAX_CAMERA_ATTACHMENT_BYTES = 12 * 1024 * 1024
export const IMAGE_COMPRESSION_MAX_DIMENSION = 1920
export const IMAGE_COMPRESSION_MIN_QUALITY = 0.55
export const IMAGE_CAMERA_COMPRESSION_MAX_DIMENSION = 1280
export const IMAGE_CAMERA_COMPRESSION_MIN_QUALITY = 0.45
