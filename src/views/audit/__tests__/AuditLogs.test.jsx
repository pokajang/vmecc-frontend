...
describe('AuditLogs onboarding anchors', () => {
  it('renders the required onboarding anchors for authorized users with visible records', async () => {
    ...
    expect(container.querySelector('[data-testid="audit-module"]')).toBeTruthy()
    expect(container.querySelector('[data-testid="audit-records-card"]')).toBeTruthy()
    expect(container.querySelector('[data-testid="audit-filters"]')).toBeTruthy()
    expect(container.querySelector('[data-testid="audit-records"]')).toBeTruthy()
    expect(container.querySelector('[data-testid="audit-results-footer"]')).toBeTruthy()
  })
  ...
  it('does not render the onboarding shell for users without audit permission', () => {
    ...
    expect(container.querySelector('[data-testid="audit-module"]')).toBeNull()
  })
