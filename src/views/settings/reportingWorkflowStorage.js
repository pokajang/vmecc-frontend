...
export const REPORTING_WORKFLOW_MODULE_DEFS = [
  {
    key: 'inspection',
    label: 'Inspection',
    description: 'TRT submitter -> AIC review -> IC approval.',
    editable: true,
  ...
  },
  {
    key: 'erco',
    label: 'ERCO',
    description: 'Reporting workflow for ERCO records (coming soon).',
    editable: false,
  ...
  },
  {
    key: 'drill',
    label: 'Drill',
    description: 'Reporting workflow for Drill records (coming soon).',
    editable: false,
  ...
  },
  {
    key: 'fitness-test',
    label: 'Fitness Test',
    description: 'Reporting workflow for Fitness Test records (coming soon).',
    editable: false,
