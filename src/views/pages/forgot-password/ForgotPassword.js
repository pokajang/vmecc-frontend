...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setStatusMessage('A reset link has been sent to the registered email. You can close this tab.')
        } catch (error) {
                        ...
                        <CCard className="border-0 shadow-sm">
                            <CCardBody className="p-4">
                                <p className="text-center text-muted mb-4">
                                    Forgot your password? <br />Enter your email and we&apos;ll send you instructions to reset it.
                                </p>
                                {statusMessage && (
