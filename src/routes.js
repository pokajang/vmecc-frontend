...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', element: Dashboard, module: 'dashboard' },
  ...
  { path: '/payroll/claims', name: 'Claims', element: Payroll, module: 'payroll.claims' },
  {
    path: '/payroll/claims/new',
    name: 'New Claim',
    element: Payroll,
    module: 'payroll.claims',
  },
  {
    path: '/payroll/claims/new/expense',
    name: 'Expense Claim',
    element: Payroll,
    module: 'payroll.claims',
  },
  {
    path: '/payroll/claims/new/salary',
    name: 'Salary Claim',
    element: Payroll,
    module: 'payroll.claims',
  },
  {
    path: '/payroll/claims/:claimId',
    name: 'Claim Detail',
    element: Payroll,
    module: 'payroll.claims',
  },
  ...
  },
  {
    ...
    name: 'Salary and Claims',
    element: StaffSalaryClaimsRedirect,
    module: 'payroll',
  },
  {
    path: '/staff/salary-claims/claims',
    name: 'Claim Records',
    element: SalaryClaimsManagement,
    module: 'payroll.salary_claims_management',
  },
  {
    path: '/staff/salary-claims/salary',
    name: 'Salary Records',
    element: SalaryClaimsManagement,
    module: 'payroll.salary_claims_management',
  },
  ...
  },
  {
    ...
    element: SalaryClaimsManagement,
    module: 'payroll.salary_assignments',
  },
  {
  ...
  { path: '/messages', name: 'Messages', element: Messages, module: 'messages' },
