...
const StaffActionModals = ({
  ...
  <>
    ...
    <UserConfirmModal
      ...
      confirmColor="danger"
      tourId="staff-directory-terminate-modal"
    ...
    <UserConfirmModal
      ...
      tourId="staff-directory-rehire-modal"
    ...
    <StaffMessageModal
      ...
      body={messageBody}
      tourId="staff-directory-message-modal"
      composerTourId="staff-directory-message-composer"
