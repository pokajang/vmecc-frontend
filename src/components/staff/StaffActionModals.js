...
const StaffActionModals = ({
  ...
  <>
    ...
    <UserConfirmModal
      ...
      confirmColor="danger"
      testId="staff-directory-terminate-modal"
    ...
    <UserConfirmModal
      ...
      testId="staff-directory-rehire-modal"
    ...
    <StaffMessageModal
      ...
      body={messageBody}
      testId="staff-directory-message-modal"
      composerTestId="staff-directory-message-composer"
