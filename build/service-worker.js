const BUILD_ID = "89282ef2ce36-20260812013614"
const CACHE_PREFIX = 'vmecc-app-shell-'
const CACHE_NAME = `${CACHE_PREFIX}${String(BUILD_ID).replace(/[^a-zA-Z0-9._-]/g, '-')}`
const BUILD_ASSETS = ["/assets/index-D_d5gKLj.js","/assets/index-yj22xnCP.css","/assets/manrope-cyrillic-wght-normal-Dvxsihut.woff2","/assets/manrope-greek-wght-normal-DL7QRZyv.woff2","/assets/manrope-latin-ext-wght-normal-Ch3YOpNY.woff2","/assets/manrope-latin-wght-normal-DHIcAJRg.woff2","/assets/manrope-vietnamese-wght-normal-usUDDRr7.woff2"]
const APP_SHELL = [
  '/',
  '/index.html',
