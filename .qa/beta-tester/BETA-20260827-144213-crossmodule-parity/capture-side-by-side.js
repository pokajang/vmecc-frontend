...
const runId = 'BETA-20260827-144213-crossmodule-parity'
  ...
  harness: [
    {
      ...
      cause: 'The first generic button in the Inspection Choose type region was Add type',
      correction: 'Select the named Emergency Response Auxiliary Equipment type action',
      productImpact: 'none',
    },
    {
      classification: 'harness invalidation',
      cause:
        'The disposable runner omitted the project-native module-registry isolation, so the local registry hid Payroll quick actions',
      correction:
        'Install the same fallback-enabled settings/modules response used by the existing application parity test',
      productImpact: 'none; role authorization remains active and navigation remains visible UI',
    },
  ],
